...
const char *topic_sub_led = "alterna_led_carlos_IFPR";
const char *topic_sub_led2 = "alterna_led_carlos_IFPR2";
...
const char *mqtt_id = "TesteCarlosIOT_ESP32_IFPR";  //Identificacao do dispositivo
...
void callback(char *topic, byte *message, unsigned int length) {
  ...
  if (String(topic) == topic_sub_led2) {
    if (messageTemp == "0"){
